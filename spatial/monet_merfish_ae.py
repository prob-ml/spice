...
if __name__=='__main__':
    ...
    trainer = pl.Trainer(flush_logs_every_n_steps=12,log_every_n_steps=12, gpus=1, max_epochs=100)
    trainer.fit(model, DataLoader(merfish_train, batch_size=1, num_workers=2),
